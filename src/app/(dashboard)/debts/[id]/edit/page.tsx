  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
        <h1 className="text-xl font-bold text-gray-900 dark:text-white mb-1">Edit debt</h1>
        <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">Update the details for this debt.</p>
        <DebtForm
